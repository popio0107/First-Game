...
- [Tilemaps](https://www.aseprite.org/docs/tilemap/)
    - When importing tile data, select **Import Mode: Tile Set**. This will tell Unity to generate [Tile assets](https://docs.unity3d.com/6000.3/Documentation/Manual/Tilemap-TileAsset.html) for each Aseprite Tile, and a [Tile Palette](https://docs.unity3d.com/6000.3/Documentation/Manual/Tilemap-Palette.html) to store them all in.
